...
<body>
    <div class="pagecontainer">
        ...
        <div class="sidecontent">
            <div class="keskmine_vanus container"><p>Osalejate keskmine vanus:</p><br><?php echo $analytics_age; ?></div>
            <div class="osalejad_kokku container"><p>Osalejaid kokku:</p><br><?php echo $analytics_participants; ?></div>
            <div class="keskmine_tulemus container"><p>Keskmine tulemus:</p><br><?php echo $analytics_score; ?></div>
